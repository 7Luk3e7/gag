...
local function isUnwanted(petName)
    ...
    if string.find(name, "fih") or string.find(name, "owl") or string.find(name, "fih") or string.find(name, "robin") or string.find(name, "baldeagle") or string.find(name, "fih") or string.find(name, "bee") or string.find(name, "fih") or string.find(name, "deer") or string.find(name, "turtle") or string.find(name, "frog") then
        return true
    end
    return false
end
